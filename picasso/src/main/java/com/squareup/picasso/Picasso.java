...
public class Picasso {
  ...
  final Bitmap.Config defaultBitmapConfig;//TODO 根据2.5.2 修改
  ...
  Picasso(Context context, Dispatcher dispatcher, Cache cache, Listener listener,
      ...
      Stats stats,Bitmap.Config defaultBitmapConfig, boolean indicatorsEnabled, boolean loggingEnabled) {
...
//      throw new IllegalArgumentException("Path must not be empty.");
      Log.e("picasso","Path must not be empty.");
      return new RequestCreator(this, null, 0);
    }
  ...
  public static class Builder {
    ...
    public Picasso build() {
      ...
      return new Picasso(context, dispatcher, cache, listener, transformer,
          requestHandlers, stats, defaultBitmapConfig ,indicatorsEnabled, loggingEnabled);//TODO 根据2.5.2 修改
    }
  }
